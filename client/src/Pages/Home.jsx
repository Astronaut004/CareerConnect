  ...
  return (
    <div className="w-full h-screen bg-amber-50 overflow-x-hidden flex">
      ...
      <div className="bg-amber-100 h-full w-1/2 flex flex-col justify-center items-center text-center space-y-6">
        ...
        <p className="text-lg text-stone-700 opacity-90 px-4">
        ...
        <div className="flex space-x-4">
          <Link
            to="/login"
            className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded-full font-semibold shadow-md transition"
          >
            Login
          </Link>
          <Link
            to="/register"
            className="bg-amber-400 hover:bg-amber-500 text-white px-6 py-2 rounded-full font-semibold shadow-md transition"
          >
            Register
          </Link>
        </div>
